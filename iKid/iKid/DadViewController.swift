...
class DadViewController: UIViewController {
    ...
    fileprivate var joke : DadJokeView!
    fileprivate var resolve : DadResolveViewController!
    ...
    fileprivate func resolveBuilder() {
        if resolve == nil {
            resolve =
                (storyboard?
                    .instantiateViewController(withIdentifier: "DadResolve")
                    as! DadResolveViewController)
        }
    }
