...
class PunnyViewController: UIViewController {
    ...
    fileprivate var joke : PunnyJokeView!
    fileprivate var resolve : PunnyResolveViewController!
    
    fileprivate func jokeBuilder() {
        if joke == nil {
            joke =
                (storyboard?
                    .instantiateViewController(withIdentifier: "PunnyJoke")
                    as! PunnyJokeView)
        }
    }
    fileprivate func resolveBuilder() {
        if resolve == nil {
            resolve =
                (storyboard?
                    .instantiateViewController(withIdentifier: "PunnyResolve")
                    as! PunnyResolveViewController)
        }
    }
